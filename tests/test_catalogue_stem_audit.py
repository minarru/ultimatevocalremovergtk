...
class StructuredCatalogueStemAuditTests(unittest.TestCase):
    ...
    def test_structural_audit_does_not_mix_in_on_disk_reference_drift(self) -> None:
        ...
        self.assertEqual(evidence.expected, ("154", "124", "92"))
    ...
    def test_canonical_snapshot_is_408_2_0_with_bidirectional_row_parity(self) -> None:
        ...
        self.assertEqual(len(identity_by_id), 410)
        self.assertEqual(
