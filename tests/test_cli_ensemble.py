...
class EnsembleParserTests(unittest.TestCase):
    ...
    def test_explicit_stems_override_saved_ensemble_subset(self) -> None:
        self._assert_explicit_stems_override_saved_selection("both", "")
    ...
    def _assert_explicit_stems_override_saved_selection(self, stems: str, focus: str) -> None:
        ...
        def apply_preset(target: Settings, _name: str) -> SimpleNamespace:
            ...
            target.ensemble.main_stem = "mode.multi_stem"
            target.ensemble.stems_selected = ["instrument.drums"]
            target.process.stem_focus = "mix.instrumental"
        ...
        with (
            ...
            patch("core.debug_log.log_event"),
        ):
